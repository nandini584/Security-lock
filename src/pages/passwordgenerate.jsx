...
const GenerateRandomPswd = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center bg-purple-100 p-20 w-2/5 rounded-lg'>
        ...
        <button onClick={handleclick} disabled={disabled} className='bg-purple-800 text-white font-regular text-as py-2 px-8 border-2 hover:border-2 hover:border-purple-700 font-bold border-purple-400 rounded-full hover:bg-white hover:text-purple-800'>Save</button>
    </div>
  )
}
